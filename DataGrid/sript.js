...
class DataGrid {
      ...
      this.data.forEach(rowData => {
        ...
        for (let i = 0; i < maxColumns; i++) {
          ...
          cell.addEventListener('blur', (event) => {
            ...
            // Assuming 'column' is used for property names
            this.data[rowIndex][columnIndex] = updatedValue; 
  ...
  const data = [
    ...
    { id: 11, name: 'Emma', age: 37, country: 'UK', education: { degree: 'Masters', field: 'Computer Science' } },
    { id: 12, name: 'William', age: 39, department: 'Finance', experience: '10 years' },
    { id: 13, name: 'Olivia', age: 31, interests: ['music', 'photography', 'cooking'] },
    { id: 14, name: 'James', age: 27, city: 'Los Angeles', status: 'Single' },
    { id: 15, name: 'Mia', age: 36, country: 'Australia', occupation: 'Doctor' },
    { id: 16, name: 'Alexander', age: 32, language: 'French', hobbies: ['painting', 'gardening'] },
    { id: 17, name: 'Charlotte', age: 34, profession: 'Lawyer', experience: '8 years' },
    { id: 18, name: 'Ethan', age: 41, city: 'Chicago', hobbies: ['sports', 'cooking'] },
    { id: 19, name: 'Ava', age: 26, country: 'France', education: { degree: 'PhD', field: 'Physics' } },
    { id: 20, name: 'Benjamin', age: 38, department: 'Marketing', role: 'Director' },
    { id: 21, name: 'Amelia', age: 29, interests: ['yoga', 'meditation'] },
    { id: 22, name: 'Liam', age: 35, city: 'Toronto', status: 'Married' },
    { id: 23, name: 'Harper', age: 30, occupation: 'Artist', experience: '5 years' },
    { id: 24, name: 'Lucas', age: 31, language: 'German', hobbies: ['music', 'reading'] },
    { id: 25, name: 'Evelyn', age: 37, profession: 'Nurse', country: 'Canada' },
    { id: 26, name: 'Mason', age: 33, city: 'Vancouver', education: { degree: 'Bachelor', field: 'Business' } },
    { id: 27, name: 'Abigail', age: 28, hobbies: ['dancing', 'cooking'] },
    { id: 28, name: 'Logan', age: 34, department: 'HR', role: 'Recruiter' },
    { id: 29, name: 'Elizabeth', age: 40, country: 'Germany', occupation: 'Architect' },
    { id: 30, name: 'Oliver', age: 39, language: 'Italian', hobbies: ['traveling', 'photography'] },
    ...
    { id: 35, name: 'Sofia', age: 31, occupation: 'Pharmacist', experience: '7 years' },
    { id: 36, name: 'Jack', age: 33, country: 'Japan', education: { degree: 'Bachelor', field: 'Economics' } },
    { id: 37, name: 'Madison', age: 36, language: 'Chinese', hobbies: ['writing', 'painting'] },
    { id: 38, name: 'Aiden', age: 30, profession: 'Consultant', city: 'Tokyo' },
    { id: 39, name: 'Chloe', age: 32, country: 'Brazil', occupation: 'Psychologist' },
    { id: 40, name: 'Lucy', age: 28, hobbies: ['cooking', 'gardening'] },
    { id: 41, name: 'Mateo', age: 34, city: 'Rio de Janeiro', status: 'Married' },
    { id: 42, name: 'Aria', age: 31, occupation: 'Professor', experience: '9 years' },
    { id: 43, name: 'Grayson', age: 35, country: 'Mexico', education: { degree: 'PhD', field: 'Chemistry' } },
    { id: 44, name: 'Eleanor', age: 33, language: 'Russian', hobbies: ['skiing', 'reading'] },
    { id: 45, name: 'Liam', age: 29, profession: 'Software Engineer', city: 'San Francisco' },
    { id: 46, name: 'Emma', age: 37, country: 'India', occupation: 'Entrepreneur' },
    { id: 47, name: 'Penelope', age: 36, language: 'Arabic', hobbies: ['traveling', 'yoga'] },
    { id: 48, name: 'Mason', age: 32, city: 'Seoul', status: 'Single' },
    { id: 49, name: 'Aurora', age: 30, occupation: 'Dentist', experience: '6 years' },
    { id: 50, name: 'Ethan', age: 38, country: 'South Africa', education: { degree: 'Masters', field: 'Marketing' } }
  ];
